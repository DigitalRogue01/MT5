...
REM Start the live watcher against local Ollama on this machine.
start "AI Camarilla Watcher" /min %PYTHON_EXE% "%WATCHER%" ^
...
start "AI Watch Panel" %PYTHON_EXE% "%POPUP%" --always-on-top
